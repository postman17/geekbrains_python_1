...
pattern_email = '[a-z_\d]+@[a-z]+\.(ru|com|org)'
if re.match(pattern_name, name) and re.match(pattern_name, surname) and re.match(pattern_email, email):
    print('Введенные данные валидны!')
else:
